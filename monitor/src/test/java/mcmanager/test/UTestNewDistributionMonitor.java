...
public class UTestNewDistributionMonitor extends UnitilsJUnit4 {
    ...
    public void testExecuteInternal() throws Throwable {
        ...
        System.out.println(DaoFactory.getInstance().getGroupDao().getGroup(1));
        System.out.println(DaoFactory.getInstance().getGroupDao().getGroup(2));
        System.out.println(DaoFactory.getInstance().getGroupDao().getGroup(3));
        System.out.println(DaoFactory.getInstance().getGroupDao().getGroup(41));    
